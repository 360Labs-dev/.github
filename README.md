...
[![Website](https://img.shields.io/badge/Website-360labs.dev-blue)](https://360labs.dev)
[![Research Lab](https://img.shields.io/badge/Research-360labs.ai-purple)](https://360labs.ai)
[![Email](https://img.shields.io/badge/Email-pra%40360labs.dev-red)](mailto:pra@360labs.dev)
...
### AI Product Studio ([360labs.dev](https://360labs.dev))
...
## 🔬 AI Research Lab ([360labs.ai](https://360labs.ai))
...
**Status:** ✅ Released (Research Paper Available)

A family of fine-tuned medical AI models optimized for Indian healthcare contexts:

| Model | Parameters | Status | Use Case |
|-------|------------|--------|----------|
| **Med360 Lite** | 4B | ✅ Released | Mobile, edge deployment, rural healthcare |
| **Med360 Pro** | 12B | 🔄 Planned Q2 2026 | Clinical decision support, hospitals |
| **Med360 Ultra** | 27B | 📋 Planned Q4 2026 | Advanced diagnostics, research |
...
**Research Paper:** [📄 View Full Paper](./Dr_Saab_Research_Paper.md)
...
- Apply: [360labs.ai/med360/free-access](https://360labs.ai/med360/free-access)
...
Stay tuned for updates at [360labs.ai](https://360labs.ai)
...
- **Minimum Project Budget:** ₹1,00,000 (~$1,200 USD)
...
[![GitHub](https://img.shields.io/badge/GitHub-100rabhkr%2Fpromptctl-blue)](https://github.com/100rabhkr/promptctl)
[![License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Stars](https://img.shields.io/github/stars/100rabhkr/promptctl?style=social)](https://github.com/100rabhkr/promptctl/stargazers)

The definitive CLI tool for treating prompts as code with enterprise-grade testing and monitoring.

**Key Features:**
- 📄 **Prompts as Code** - Define prompts in Markdown with YAML frontmatter
- ✅ **Test-Driven Development** - Assert output quality using exact matches, regex, semantic similarity, or JSON schema
- 📊 **Bulk Evaluation** - Run hundreds of test cases in seconds with pass/fail rates and latency metrics
- ⚖️ **A/B Testing** - Scientific prompt comparison with statistical confidence intervals
- 📈 **Local Dashboard** - Visualize run history, inspect traces, and analyze costs
- 🔌 **Multi-Provider Support** - Google Gemini (1.5, 2.0, 2.5, 3.0), extensible for OpenAI, Anthropic, and local models
...
[![npm](https://img.shields.io/badge/npm-%40360labs%2Flive--transcribe-red)](https://www.npmjs.com/package/@360labs/live-transcribe)
[![Downloads](https://img.shields.io/npm/dm/@360labs/live-transcribe)](https://www.npmjs.com/package/@360labs/live-transcribe)
...
- 🔌 **Extensible Architecture** - Add custom providers easily
...
- **promptctl**: [CONTRIBUTING.md](https://github.com/100rabhkr/promptctl/blob/main/CONTRIBUTING.md)
...
### Quick Contact
- **Email:** [pra@360labs.dev](mailto:pra@360labs.dev)
- **Website:** [360labs.dev](https://360labs.dev)
- **Research Lab:** [360labs.ai](https://360labs.ai)
...
✅ **AI-Native Expertise** - Built on cutting-edge models and frameworks  
✅ **Product Thinking** - Solutions that users actually want to use  
✅ **Rapid Iteration** - Ship prototypes in 24 hours, production in weeks  
✅ **India-First Innovation** - Deep understanding of Indian market needs  
✅ **Research-Backed** - Published papers and proven methodologies  
✅ **Full Stack** - From AI research to production deployment  
...
- [Privacy Policy](https://360labs.dev/privacy)
- [Terms & Conditions](https://360labs.dev/terms)
...
[Website](https://360labs.dev) • [Research](https://360labs.ai) • [Contact](mailto:pra@360labs.dev)

---

© 2026 Lightyear 360 Labs Pvt Ltd. All rights reserved.
